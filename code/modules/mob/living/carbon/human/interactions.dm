	...
	if (H.gender == MALE)
		...
		if (H.species.genitals)
			if (hole == "mouth")
				...
				message = pick("кончает [P] в задницу.", "спускает семенную жидкость в зад [P].", "извергает сем[ya] в пр[ya]мую кишку [P].", "выстреливает семенем в пр[ya]мую кишку [P].", "спускает в зад [P], придержива[ya] [P.identifying_gender == MALE ? "его" : "её"] бёдра", "держась за бёдра [P] кончает [P.identifying_gender == MALE ? "ему" : "ей"] в зад.", "извергает сем[ya] в зад [P], держа [P.identifying_gender == MALE ? "того" : "ту"] за бёдра.", "спускает в пр[ya]мую кишку [P].", "спускает в задницу [P]")
