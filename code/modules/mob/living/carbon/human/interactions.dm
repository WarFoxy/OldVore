...
/*			else if (hole == "assfuck")
				message = pick("������� [H] �� ������� � [H.identifying_gender == MALE ? "��" : "���"] ������� [H] � ���.", "������� [H] �� ���[ya]���������[ya] ������[ya]�� ������� [H] �������.", "�����[ya] [H] �� ������� ������[ya]�� [H.identifying_gender == MALE ? "���" : "��"] �������� �������� �������� ���� � ��[ya]��� �����.", "� ��������� ������ ���[ya]������ ���� �� �������, ��-�� ���� [H] ������� ������� �� ���� �����.", "� ��������� ������ ���[ya]������ ���� �� ����� ��[ya]��� �����, ��-�� ���� [H] ������� �� ���� �����", "� ��������� ������ ���[ya]������ ���� �� ����� ��[ya]��� �����, ��-�� ���� [H] ������� ������� �� ���� �����", "� ��������� ������ ���[ya]������ ���� �� ����� ��[ya]��� �����, ��-�� ���� [H] ������� �� [H.identifying_gender == MALE ? "���" : "�"] �����������")

���� ������� ������ ��������� �������� ��� ���������������, �������� ��� ������ ���������.
� ��� ������ ��� ����. ������ ��� ��� ����� ������� ���������.
*/
			else if (hole == "assfuck")
				message = pick("������� [P] � �������.", "�������� �������� �������� � ����� [P].", "��������� ���[ya] � ��[ya]��� ����� [P].", "������������ ������� � ��[ya]��� ����� [P].", "�������� � ��� [P], ����������[ya] [P.identifying_gender == MALE ? "���" : "�"] ����", "������� [P] �� ���� ������� [P.identifying_gender == MALE ? "���" : "��"] � ���.", "��������� ���[ya] � ��� [P], ����� [P.identifying_gender == MALE ? "����" : "��"] �� ����.", "�������� � ��[ya]��� ����� [P].", "�������� � ������� [P]")
		...
		if("oral")
			...
			if (prob(35))
				...
				if(P.species.get_bodytype() == SPECIES_UNATHI || P.species.get_bodytype() == SPECIES_AKULA || P.species.get_bodytype() == SPECIES_SERGAL || P.species.get_bodytype() == SPECIES_TESHARI)
					message = pick("��������[ya] �� ����� [P], ����������[ya] [P.identifying_gender==FEMALE ? "�" : "���"] � ��������[ya] ���� �� ������� � ������� [P.identifying_gender==FEMALE ? "��" : "���"] � ������.", "������� [P] � �������� �����.", "���������� ������ [P] �� ���� ����.", "������ [P] �� ������ ����[ya] ������ � ��������� �������[ya] �����.", "��� �������� [P], ��������[ya] ����� [P.identifying_gender == FEMALE ? "������ [ya]�����" : "������� [ya]����"] � �����.", "��������� ���������[ya] ������� [P].", ", ���� ������ ����, ���[ya]������ ������ [P] �� ������ ������.", ", ���������� ���������, ������ ������ ���� ��� [P] � ������ �� ������������[ya] ������ �����.")
				if(P.species.get_bodytype() == SPECIES_TAJ || P.species.get_bodytype() == SPECIES_VULPKANIN || P.species.get_bodytype() == SPECIES_ZORREN_HIGH || P.species.get_bodytype() == SPECIES_ZORREN_FLAT)
					message = pick("��������[ya] �� ����� [P], ����������[ya] [P.identifying_gender==FEMALE ? "�" : "���"] � ��������[ya] ���� �� ������� � ������� [P.identifying_gender==FEMALE ? "��" : "���"] � ������.", "������� [P] � �������� �����.", "���������� ������ [P] �� ���� ����.", "������ [P] �� ������ ����[ya] ������ � ��������� �������[ya] �����.", "��� �������� [P], ��������[ya] ����� [P.identifying_gender == FEMALE ? "������ �������" : "������� ������"] � �����.", "��������� ���������[ya] ������� [P].", ", ���� ������ ����, ���[ya]������ ������ [P] �� ������ ������.", ", ���������� ���������, ������ ������ ���� ��� [P] � ������ �� ������������[ya] ������.")
				if(P.species.get_bodytype() == SPECIES_VOX || P.species.get_bodytype() == SPECIES_NEVREAN)
					message = pick("��������[ya] �� ����� [P], ����������[ya] [P.identifying_gender==FEMALE ? "�" : "���"] � ��������[ya] ���� �� ������� � ������� [P.identifying_gender==FEMALE ? "��" : "���"] � ������.", "������� [P] ��[ya]�� � ����.", "���������� ������ [P] �� ���� ����, �����[ya]�� �� ���������[ya] � ������� �� �����.", "������ [P] �� ������ ����[ya] ������ � ��������� �������[ya] �����.", "������� ����[ya] �� ������ [P], ��������[ya] ����� ������ ������ � ���.", "��������� ���������[ya] ������� [P].", ", ���� ������ ����, ���[ya]������ ������ [P] �� ������ ������.", ", ���������� ���������, ������ ������ ���� ��� [P] � ������ �� ��������� ��������.")
				if(P.species.get_bodytype() == SPECIES_PROMETHEAN)
 ...
 */
		...
		if ("mount")
			...
			if(P.species.get_bodytype() == SPECIES_VULPKANIN || P.species.get_bodytype() == SPECIES_ZORREN_HIGH || P.species.get_bodytype() == SPECIES_ZORREN_FLAT)
				...
				if (H.lastfucked != P || H.lfhole != hole)
					message = pick("�������� ���������[ya] �� ��������� ����� [P], ����[ya] ��� ������", "������ ��������� ����� [P] � ���� �����, �������[ya][ya] ��� �����", "����� �������[ya]�� ���� [P] � ��� ���������", "��������� ������ ����� [P] � ��� �����", "��������� ���������� ������� [P] � ���� �����������")
					H.lastfucked = P
					H.lfhole = hole
			...
			if(P.species.get_bodytype() == SPECIES_UNATHI)
				...
				if (H.lastfucked != P || H.lfhole != hole)
					message = pick("�������� ���������[ya] �� ���� �� ������� [P]", "������ ���� �� ������� [P] � ���� �����, �������[ya][ya] ��� �����", "�������[ya]�� ���� �� ������ [P] � ���� �����, ������[ya] ���� �����", "��������� ������ ����� [P] � ��� �����", "��������� ������ �� �������� [P] � ���� �����������")
					H.lastfucked = P
					H.lfhole = hole
			...
			if(P.species.get_bodytype() == SPECIES_AKULA || P.species.get_bodytype() == SPECIES_SERGAL || P.species.get_bodytype() == SPECIES_VOX || P.species.get_bodytype() == SPECIES_NEVREAN)
				message = pick("��������� ������ �� ����� [P]", "������� ���� [P], ������ ���������", "������ �� ����� [P]", "������� �� ����������� [P]", "�����������[ya] �� [P]", "��������[ya] � [P]")
				if (prob(35))
					message = pick("����[ya]�� ��������� [P] � ��� ��������� �� ����� [ya]���", "������ �� ������ [P], �������[ya] ��� � ��� ����", "�����������[ya] �������� �� ����� [P], ����[ya] ��� � ���[ya] �� �����", "������� �� ����������� [P], �����[ya] ����� ���������", "������ �� [P], �������[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ����� � ���� ����", "������� �� [P], ����[ya][ya]�� � [P.identifying_gender==FEMALE ? "�" : "���"] ����", "������ �� �����, �������[ya][ya] ������������ ���� � [P]", "[H.identifying_gender==FEMALE ? "�������" : "����[ya]"] ����� � [P] � ������, ����� [P.identifying_gender==FEMALE ? "�" : "���"] ���� ������ ���[ya]", "������� ����� ��-�����, ���[ya] �� ����������� [P], �����[ya] ��� �������� ���������", "���������� �����������[ya] �� [P], �����[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ���� ������������ ������", "����������� ���� �� ������ [P], ���[ya] �� ���� ����� �����", "��������[ya] �����-����, ���[ya] �� ������� [P]")
...
//Basics EXEPT PROMETHEANS AND TESHARI
	...
	// Basics + vulps
			...
			if(P.species.get_bodytype() == SPECIES_VULPKANIN || P.species.get_bodytype() == SPECIES_ZORREN_HIGH || P.species.get_bodytype() == SPECIES_ZORREN_FLAT && H.species.get_bodytype() != SPECIES_TESHARI && H.species.get_bodytype() != SPECIES_PROMETHEAN)
				...
				if (prob(35))
					message = pick("�����������[ya] �������� �� �������������[ya] ����� ��������� [P] �� ����� [ya]���", "������ �� ������ [P], �������[ya] ��� � ���� ��� � ���[ya] ������� �������� �� ����", "������ �� ��������� ����� [P], ����[ya][ya]�� � [P.identifying_gender==FEMALE ? "�" : "���"] ����", "������� �� ����� [P], ����[ya]�� [P.identifying_gender==FEMALE ? "�" : "���"] ���� ����������", "������, �������[ya][ya] ������������ ���� � [P]", "[H.identifying_gender==FEMALE ? "�������" : "����[ya]"] ����� � [P] � ������, ����� [P.identifying_gender==FEMALE ? "�" : "���"] ���� ������ ���[ya]", "������� ����� ��-�����, ���[ya] ����� �� ����������� [P], �����[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ���� �������� ��[ya]��� �����", "�����������[ya] �� [P], �������[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ��������� ���� � ��[ya]��� ����� �� �����", "���������� �����������[ya] �� [P], �����[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ���� ��[ya]��� ������", "������[ya] �� ���� [P], ���[ya] �� ���� ����� �����", "��������[ya] �����-����, ���[ya] ����� �������� ������� [P]")
	...
	// Basics + unathi ------- ������� �������� � ������ �� 1 � 2 �����
			...
			if(P.species.get_bodytype() == SPECIES_UNATHI && H.species.get_bodytype() != SPECIES_TESHARI && H.species.get_bodytype() != SPECIES_PROMETHEAN)
				message = pick("������� ���[ya] � ��� ������� [P], ��������[ya]�� �� ����", "���������� ������� ���[ya] ����� �� ������ [P]", "��������� ������ �� ����� �� ������ [P], �������[ya] ��� � ���� ���, �������[ya][ya] ������ �������[ya] � �����", "������ �� ����� �� ������ [P], �������[ya] ��� � ���� ���, �������[ya][ya] ������ �������[ya] � ���� �����������", "�������� ����� �����-���� �� ����� �� ������ [P], ���� �������� �������", "������ �� ������ [P], �������[ya] ��� � ���� ���")
				if (prob(35))
					message = pick("��������� �����������[ya] �������� ���������� �� ����� [P], ����[ya] �� � ��[ya]��� �����", "������ �� ����� ��������� [P], �������[ya] �� � ���� ��� �� �����", "�����������[ya] �� ���������� [P] �������� �� ����� [ya]���", "������� �� [P], �������[ya] ��� ����� � ��[ya]��� ����� � ����[ya][ya]�� � [P.identifying_gender==FEMALE ? "�" : "���"] ����", "������ �� �����, �������[ya][ya] ������������ ���� � [P]", "[H.identifying_gender==FEMALE ? "�������" : "����[ya]"] ����� � [P] � ������, ����� [P.identifying_gender==FEMALE ? "�" : "���"] ���� ������ ���[ya]", "������� ����� ��-�����, ���[ya] ����� �� ����������� [P], �����[ya] ��� ������", "���������� �����������[ya] �� [P], �����[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ���� �������� ��[ya]��� �����", "�����������[ya] �� ����� [P], ���[ya] �� ���� ����� �����", "��������[ya] �����-����, ���[ya] �������[ya] ������� ���� � ���� ����� [P]")

				if (H.lastfucked != P || H.lfhole != hole)
					message = pick("�������� ������[ya] ������ �� ������ �� ��������� [P], ����[ya] ��� ������", "��������� ������ ����� [P] � ���� ������ ������", "�������[ya]�� ���� �� ������ [P] � ���� ����, ������[ya] ���� �����", "��������� ������ ����� [P] � ���� ��[ya]��� �����", "��������� ������ �� �������� [P] � ���� ��[ya]��� �����", "��������� ���[ya] [P] � ���� �������� �����")
					H.lastfucked = P
					H.lfhole = hole
	...
	// Basics + akula sergal vox
			...
			if(P.species.get_bodytype() == SPECIES_AKULA || P.species.get_bodytype() == SPECIES_SERGAL || P.species.get_bodytype() == SPECIES_VOX || P.species.get_bodytype() == SPECIES_NEVREAN && H.species.get_bodytype() != SPECIES_TESHARI && H.species.get_bodytype() != SPECIES_PROMETHEAN)
				message = pick("������� ���[ya] � ��� ������� [P], ��������[ya]�� �� ����", "������� ����� �� ����������� [P], ���� �������� �������", "���������� ������� ���[ya] ������ [P]", "�����������[ya] ������ �� ����� [P], ����[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ����� � ��[ya]��� �����")
				if (prob(35))
					message = pick("����[ya]�� ��������� [P] � ���� ��� �� ����� [ya]���", "��������� ������ �� ����� [P], �������[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ����� � ���� ���", "������ �� ������ [P], �������[ya] ��� � ���� �����", "������� �� ����� [P], ����[ya][ya]�� � [P.identifying_gender==FEMALE ? "�" : "���"] ����", "������ �� �����, �������[ya][ya] ������������ ���� � [P]", "[H.identifying_gender==FEMALE ? "�������" : "����[ya]"] ����� � [P] � ������, ����� [P.identifying_gender==FEMALE ? "�" : "���"] ���� ������ ���[ya]", "������� ����� ��-�����, ���[ya] ����� �� ����������� [P], �����[ya] ��� ������", "���������� �����������[ya] �� [P], �����[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ���� �������� ��[ya]��� �����", "�����������[ya] �� ����� [P], ���[ya] �� ���� ����� �����", "��������[ya] �����-����, ���[ya] ����� �� ������� [P]")
...
//Teshari
	...
	//H.Teshari + unathi ------- ������� �������� � ������ �� 1 � 2 �����
			if(H.species.get_bodytype() == SPECIES_TESHARI && P.species.get_bodytype() == SPECIES_UNATHI)
				message = pick("������� ���[ya] � ������, ��������[ya]�� �� ����� [P]", "������� ����� �� ����������� [P], ���� ��������� ������", "���������� ������� ���[ya] ������ [P]")
				if (prob(35))
					message = pick("��������� �����������[ya] ������� �� ����� [P], ����[ya] �� � �����","�����������[ya] ������� �� ���� �� ������ [P], ������[ya][ya] ������ �������[ya] � �����", "�����������[ya] �� ���� �� ������ [P] �������, ������[ya][ya] ������ �������[ya] � ����������", "��������� ������ �� ����� �� ��������� [P]", "������ �� ����� �� ������, �������[ya][ya] ������������ ���� � [P]", "���������� ������� ����� ��-�����, ���[ya] ����� �� ����������� [P], �����[ya] ��� ����� ������", "���������� �����������[ya] �� [P], �����[ya] [P.identifying_gender==FEMALE ? "�" : "���"] ����� �������", "��������[ya] �����-����, ���[ya] �� ������� [P]")
				else if (prob(20))
